...
Horizontal Retail Group Messy Dataset
...
Horizontal Retail Group Dataset after cleaning and transform the dataset into Power Query. 
...
Based on the analysis, Horizon Retail Group can:
